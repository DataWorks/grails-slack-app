...
grails.plugin.springsecurity.interceptUrlMap = [
	'/':                  ['ROLE_NO_ROLES'],
	'/index':             ['ROLE_NO_ROLES'],
	'/index.gsp':         ['ROLE_NO_ROLES'],
	'/assets/**':         ['ROLE_NO_ROLES'],
	'/templates/**':      ['ROLE_NO_ROLES'],
	'/**/js/**':          ['ROLE_NO_ROLES'],
	'/**/css/**':         ['ROLE_NO_ROLES'],
	'/**/images/**':      ['ROLE_NO_ROLES'],
	'/**/favicon.ico':    ['ROLE_NO_ROLES'],
	'/stomp/**':          ['ROLE_NO_ROLES'],
	'/slackChannel/**':   ['ROLE_NO_ROLES'],
	'/slackToken/**':     ['ROLE_NO_ROLES'],
